      ...
      <nav class="">
        ...
        <a href="index.php?page=category" class="nav-link <?php echo $actual_link=='category'?'active':'';?>">
          ...
          <!-- buy sidebar  -->
           ...
           <li class="nav-item has-treeview">
            <a href="#" class="nav-link <?php 
              if ($actual_link == 'profit_loss' || $actual_link =='sales_report' || $actual_link =='inventory_report' || $actual_link =='purchase_pay_report' || $actual_link =='sell_pay_report') {echo "active";
          }else{
            echo "";
          }
            ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?page=inventory_report" class="nav-link <?php echo $actual_link=='inventory_report'?'active':'';?>">
