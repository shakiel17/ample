...
<head>
  ...
  <title>Arianne Joelle Construction Supply</title>
...
<marquee behavior="scroll" direction="left" scrollamount="4"><p style="color: black;">
                Welcome to Arianne Joelle Construction Supply Inventory System</p>
            </marquee>
 <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
      ...
      <div class="notice">
                 <li>
                    ...
                    <li> <i class="material-symbols-outlined"><a href="mailto: @gmail.com" target="_blank"> mail</a></i></li>
                    <li>
